...
class WaveView@JvmOverloads constructor(
    ...
    private fun init() {
        ...
        circlePaint!!.color = Color.parseColor("#FFADE5FC")
    ...
    private fun drawText(canvas: Canvas) {
        ...
        canvas.drawText((textProgress).toString()+"ml", targetRect.centerX().toFloat(), baseline.toFloat(), textPaint!!)
    }
    /**
     * 画波浪
     *
    ...
    private fun drawWave(canvas: Canvas) {
        ...
        wavePaint!!.color = Color.parseColor("#5DCCFC")
